...
- **Anesthésiste** : réalise la consultation pré‑anesthésique, décide (autoriser / examens / avis / récuser), génère la synthèse.
...
### 6.1 Pré‑op : questionnaire → scores → décision
...
4. L’anesthésiste réalise la consultation pré‑anesthésique et prend une décision : autoriser l’anesthésie, demander des examens complémentaires, demander un avis spécialisé, ou récuser l’anesthésie.
...
**FR-08 — Consultation pré‑anesthésique & décision (EF-08, P1)**
- Description : À l’issue de la consultation, l’anesthésiste peut corriger les informations collectées et formaliser une décision (autorisation, examens complémentaires, avis spécialisé, ou récusation).
- Critères d’acceptation :
  - Les corrections sont historisées et auditées.
  - La décision est persistée, horodatée et liée à l’auteur.
  - La décision est visible dans le dossier (statut ou champ dédié), avec l’option de mise à jour selon le workflow clinique.
